locals {
  ...
  aws_account_id = "000000000004" # TODO(owner): real account id (registry placeholder). Until then no stack can run here
  # IAM account alias: globally unique across AWS, lowercase. TODO(owner): change it if it is taken.
  account_alias = "ok-karthik-shared-services"
  ...
  data_classification = "internal"      # shared network infrastructure, not application data
}
